...
export const SendIcon: React.FC<IconProps> = ({ className = '', size = 'sm' }) => (
  <svg className={`${sizeClasses[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 10l7-7m0 0l7 7m-7-7v18" />
  </svg>
);

export const ReceiveIcon: React.FC<IconProps> = ({ className = '', size = 'sm' }) => (
  <svg className={`${sizeClasses[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
  </svg>
);

export const LightningIcon: React.FC<IconProps> = ({ className = '', size = 'sm' }) => (
...
export const QrScanIcon: React.FC<IconProps> = ({ className = '', size = 'lg' }) => (
...
export const PasteIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${sizeClasses[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const EmptyWalletIcon: React.FC<IconProps> = ({ className = '', size = 'xl' }) => (
...
export const LockIcon: React.FC<IconProps> = ({ className = '', size = 'xl' }) => (
  <svg className={`${sizeClasses[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
