  ...
  return (
    <div className={`flex flex-col items-center justify-center ${className}`}>
      ...
      <div className={`relative ${config.container}`}>
        {/* Outer glow */}
        <div className="absolute inset-0 rounded-full bg-spark-amber/20 blur-xl animate-pulse" />
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <svg 
            className={`${config.bolt} text-spark-amber drop-shadow-lg`} 
            viewBox="0 0 24 24" 
            fill="currentColor"
            style={{
        ...
        <div className="absolute inset-0">
          {[0, 1, 2, 3].map((i) => (
            <div
              key={i}
              className="absolute w-1.5 h-1.5 rounded-full bg-spark-amber"
              style={{
                top: '50%',
                left: '50%',
