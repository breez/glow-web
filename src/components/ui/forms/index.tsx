...
export const FormError: React.FC<{
  ...
  return (
    <div
      className={`flex items-center gap-2 text-spark-error text-sm min-h-[1.25rem] transition-opacity duration-200 ${error ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
      aria-live="polite"
    >
      {error && (
        <>
